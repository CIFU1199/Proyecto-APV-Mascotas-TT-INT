...
router.get('/historial/:mascotaId', authMiddleware, checkRole([1, 2, 3]), historialController.obtenerHistorialMascota);

router.post('/historial/crear', authMiddleware, checkRole([1, 2]), historialController.crearRegistroHistorial);
 
router.get('/historial/:mascotaId/tipo/:tipo', authMiddleware, checkRole([1, 2, 3]), historialController.filtrarHistorialPorTipo);
